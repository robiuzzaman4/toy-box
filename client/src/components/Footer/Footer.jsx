...
const Footer = () => {
    return (
        <footer className="w-full bg-gradient-to-t from-purple-50 to-white py-8 px-4">
            <hr className="my-8 border-blue-gray-50" />
            <div className="py-4 max-w-screen-xl mx-auto flex flex-row flex-wrap items-center gap-y-6 gap-x-12 text-center md:justify-between">
                <Link to="/">
                ...
                <ul className="flex flex-wrap items-center gap-y-2 gap-x-8">
                    <li>
                        <Typography
                            color="blue-gray"
                            className="font-normal transition-colors hover:text-purple-500 focus:text-purple-500 cursor-pointer text-sm"
                        >
                            Email: toybox@mail.com
                        </Typography>
                    </li>
                    <li>
                        <Typography
